...
import com.savinik.engine_model.engine.camera.CameraController;
import com.savinik.engine_model.engine.collision.CollisionController;
import com.savinik.engine_model.engine.controller.TouchController;
...
import com.savonikaleksandr.scaner.views.DemoLoaderTask;
import com.savonikaleksandr.scaner.views.ModelViewerGUI;
...
public class ModelActivity extends AppCompatActivity implements EventListener {
    ...
    private float[] backgroundColor = new float[]{1.0f, 1.0f, 0.0f, 1.0f};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            gLView.addListener(ModelActivity.this);
