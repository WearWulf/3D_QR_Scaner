...
public class ScannerFragment extends Fragment implements BarcodeCallback {
    ...
    public void possibleResultPoints(List<ResultPoint> resultPoints) {
        //TODO: Ни в коем случае, чтобы не случилось, ничего здесь не делать!!!
        //TODO: Серьезно, вся обработка лежит на стороне ViewFinder  ¯\_(ツ)_/¯
    }
    @Override
    public void onPause() {
