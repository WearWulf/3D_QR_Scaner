...
import com.savinik.engine_model.engine.gui.CheckList;
import com.savinik.engine_model.engine.gui.GUI;
import com.savinik.engine_model.engine.gui.Glyph;
import com.savinik.engine_model.engine.gui.Menu3D;
import com.savinik.engine_model.engine.gui.Rotator;
import com.savinik.engine_model.engine.gui.Text;
import com.savinik.engine_model.engine.gui.Widget;
...
public final class ModelViewerGUI extends GUI {
    ...
    private Text fps;
    private Widget icon;
    private Glyph icon2 = Glyph.build(Glyph.CHECKBOX_OFF);
    private Menu3D menu;
